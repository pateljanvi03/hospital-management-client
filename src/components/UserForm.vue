<template>
  <ValidationObserver v-slot="{ handleSubmit }">
    <form class="h-full"  @submit.prevent ="handleSubmit(addUser)">
        ...
        <div class="px-4 py-5 bg-white sm:p-6">
          <div class="grid grid-cols-6 gap-6">
            <div class="col-span-6 sm:col-span-4">
              ...
              > {{editableData._id? "Edit" : "Add"}} User </label>
            </div>
            ...
            <div class="col-span-7 sm:col-span-4">
              <label for="name" class="ml-0 block text-sm font-medium text-black-700">UserName</label>
            ...
            <div class="col-span-6 sm:col-span-3">
              <label for="name" class="ml-0 block text-sm font-medium text-black-700">Password</label>
...
export default {
  ...
  methods: {
    ...
    async addUser() {
      this.isLoading = true;
      if(this.editableData._id) {
        await axios.put("/user/" + this.editableData._id, this.user);
      } else {
